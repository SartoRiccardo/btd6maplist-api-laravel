...
class ConfigSeeder extends Seeder
{
    ...
    private static array $configs = [
        ...
        'exp_points_casual' => ['value' => '1', 'type' => 'int', 'description' => 'Casual Exp completion points'],
        'exp_points_medium' => ['value' => '2', 'type' => 'int', 'description' => 'Medium Exp completion points'],
        'exp_points_high' => ['value' => '3', 'type' => 'int', 'description' => 'High Exp completion points'],
        'exp_points_true' => ['value' => '4', 'type' => 'int', 'description' => 'True Exp completion points'],
        'exp_points_extreme' => ['value' => '5', 'type' => 'int', 'description' => 'Extreme Exp completion points'],
